...
static DEFINE_SPINLOCK(clk_cgu_lock);
						    ...
						    struct device_node *np)
{
	...
	clk = clk_register_gate(NULL, clk_src_names[CLK_SRC_OSC], parent_name[0],
				...
				0, CLK_GATE_SET_TO_DISABLE, &clk_cgu_lock);
